...
func init() {
	...
	utilruntime.Must(modsecurityv1.AddToScheme(scheme))
...
func main() {
	...
	flag.StringVar(&serverAddr, "server-bind-address", ":8888", "The address the rule server endpoint binds to.")
	...
	go func() {
		if err := s.Serve(); err != nil {
			setupLog.Error(err, "failed to serve server")
		}
	}()
